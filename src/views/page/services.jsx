...
export default class ServicesPage extends React.Component {
  ...
  render() {
    let { tourType, stayAt, stayType } = { tourType: "honeymoon", stayAt: "hotel", stayType: "luxury" };
    ...
    let bcrumb = <div className="breadcrumb">
      <span>home</span><span className="reverse">></span>
      <span>tours</span><span className="reverse">></span>
      <span>{tourType + " tours"}</span><span className="reverse">></span>
      <span>{"stay at " + stayAt}</span><span className="reverse">></span>
      <span>{stayType}</span>
    </div>;
      ...
      <div className="services_body">
        ...
        <div className="container">
          ...
          <div className="itineraryDiv children_marginD10">
            ...
            <div className="flexRow">
              <span className="day_count">Day 1: </span>
              <span> Jakarta - City Tour</span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 2: </span>
              <span> Pangandaran - Green Canyon and local industries tour </span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 3: </span>
              <span> Boat Tour</span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 4: </span>
              <span> Yogakarta - Borobudur temple complex tour </span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 5: </span>
              <span> Yogakarta - cycling tour</span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 6: </span>
              <span> Seloliman - PPLH Guided village and rice terrace walk </span>
            </div>
            <div className="flexRow">
              <span className="day_count">Day 7: </span>
              <span> Mt Bromo -  Sunrise climb, Coffee, cocoa and rubber plantation tour </span>
            </div>
          </div>
        </div>
        <div className="container">
          ...
          <div className="formContainer" id="servicesForm">
            <Form
              method="POST"
              action="https://formspree.io/info@babylonholidays.com">

              <FormGroup tag="fieldset">
                <FormGroup>
                  <Label for="nameField">{languageLocale["FORMNAME"]}</Label>
                  <Input type="text" name="name" id="nameField" placeholder="" required/>
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                  ...
                  <Input type="email" name="email" id="emailField" placeholder="" required/>
                </FormGroup>
              </FormGroup>

              <input type="Submit"
                className="btn btn-lg product-button"
                value={languageLocale["BOOKNOW"]}
                onClick={this.hanldeSubmit.bind(this)}></input>
